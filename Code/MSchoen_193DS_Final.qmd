...
In part 1, they more than likely used a logistic regression as the response variable is the probability of American Avocet microhabitat use while the predictor variable is the distance to the water's edge. 
...
American Avocet's use of micro-habtitats varies with distance from the water edge. This suggests that proximity to water influences where and how the American Avocet chooses to use habitats.

**Part 2:**

American Avocets, Forster's Terns, and Black-necked Stilts used habitat types differently. This suggests that each species habitat preference differs within the San Francisco Bay estuary. 

## c. Further Analysis

To further the analysis, examining how the type of vegetation cover within a given area influences American Avoocet habitat use. This *numerical continuous variable* could be measured as a percentage (%) of ground cover within the study area using quadrats set at a given dimension (ex: 1m x 1m, 3ft x 3ft) and could showcase how other factors affected by vegetation cover (food, nesting area, protection from predators) influences behavior.
...
**Table 1:** Overview of the two models being run. Model 1 will have both variables, Tree Height & Ant Species interact where Model 2 won't.
